...
class Model(object):
    ...
    def predict(self, data):
        ...
        prediction_scores=self.pipeline.predict_proba(X)
        ...
        for i in prediction_scores :
            three_large=heapq.nlargest(3,i)
            large_three_scores.append(three_large)
        top_three_scores=pd.DataFrame(large_three_scores)
        top_three_scores['label']=labels     
        return top_three_scores,prediction_scores
